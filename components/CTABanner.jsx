...
export default function CTABanner({
  title = 'Ready to own your local market?',
  subtitle = 'We take on a limited number of new clients each month. Serious about growth? Let\'s talk.',
  ctaText = 'Get My Free Site Audit',
  ctaHref = '/#free-audit',
  secondaryText = null,
        ...
        <div className="relative z-10 px-8 py-10 lg:px-14 lg:py-12 flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
          ...
          >
            ...
            {/* <div className="bg-white/15 border border-white/20 rounded-xl px-4 py-3 max-w-[260px] text-center">
              <p className="text-white/85 text-xs italic leading-relaxed">&ldquo;My calls tripled in 3 weeks. Best investment I&rsquo;ve made.&rdquo;</p>
            ...
            <div className="flex flex-col items-center gap-1.5">
              <div className="flex items-center -space-x-2.5">
                {avatarInitials.map((init, i) => (
                  <div
                    key={i}
                    className={`w-8 h-8 rounded-full ${avatarColors[i]} border-2 border-white flex items-center justify-center flex-shrink-0`}
                  >
                    <span className="text-[9px] font-bold text-white">{init}</span>
                  </div>
                ))}
                <div className="w-8 h-8 rounded-full bg-white/20 border-2 border-white flex items-center justify-center flex-shrink-0">
